                                    ...
                                    {products.length > 0 ? (
                                        products.map((product) => (
                                            <TableRow key={product.id}>
                                                ...
                                                <TableCell className="capitalize whitespace-nowrap">{product.type}</TableCell>
                                                <TableCell className="whitespace-nowrap">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(product.basePrice)}</TableCell>
